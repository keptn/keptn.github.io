...
if (TypeIt) {
    var instance = new TypeIt('#typeit-editor', {
        ...
        .empty()
        .options({ speed: 100 })
        .type('<span class="command">keptn create project mycoolservice myshipyard.yaml</span>')
        .break()
        .break()
        .pause(500)
        .options({ speed: 0 })
        ...
        .empty()
        .options({ speed: 100 })
        .type('<span class="command">keptn onboard service mycoolservice values.yaml</span>')
        .break()
        .break()
        .pause(500)
        .options({ speed: 0 })
        ...
        .break()
        .break()
        .type('<span class="command">keptn new artifact mycoolservice:1.0.0</span>')
        .break()
        .break()
        .pause(500)
        .options({ speed: 0 })
        .type('Updating configuration for mycoolservice:1.0.0')
        .pause(500)
        .break()
