...
| | |
| --- | --- | 
| **Auto-remediation with Keptn: Lessons Learned during our PoC** with Saveetha Ravi, Mindtree<br><br>Saveetha Ravi joins this Keptn user group to go through an end-to-end scenario of how Keptn is used with Dynatrace to auto-remediate problems detected in production environments. | <iframe width="560" height="315" src="https://www.youtube.com/embed/TBA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> |
