...
Please find the Helm Charts here:
  ...
  - `helm-service`: GitHub Release for [0.8.7](https://github.com/keptn/keptn/releases/tag/0.8.7) at **Assets** > `helm-service-0.8.7.tgz`

  - `jmeter-service`: GitHub Release for [0.8.7](https://github.com/keptn/keptn/releases/tag/0.8.7) at **Assets** > `jmeter-service-0.8.7.tgz`
...
See the configuration parameters of the supported execution plane services:
  ...
  - `helm-service`: [Helm Chart values](https://github.com/keptn/keptn/blob/release-0.8.7/helm-service/chart/README.md#configuration)

  - `jmeter-service`: [Helm Chart values](https://github.com/keptn/keptn/blob/release-0.8.7/jmeter-service/chart/README.md#configuration)
