...
1. Download, install [K3s](https://k3s.io/) (tested with [versions 1.16 to 1.20](../k8s_support)) and run K3s using the following command:
   ```console
...
- Download the version for your operating system from: [GitHub](https://github.com/keptn/keptn/releases/tag/0.8.1)
- Unpack the archive
