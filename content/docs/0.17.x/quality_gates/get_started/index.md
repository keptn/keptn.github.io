...
The rest of this section assumes you have Keptn [installed](../../../previous-releases/install/helm-install) on your cluster, your Keptn CLI is [authenticated](../../../previous-releases/install/authenticate-cli-bridge/#authenticate-keptn-cli), and you have a deployed application that is monitored by your favorite monitoring solution.
