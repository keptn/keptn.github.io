...
To do so, please follow the instructions in the [backup guide](../../operate/#backup-and-restore-keptn)
...
1. Before starting the update, we strongly advise to create a backup of your Keptn projects. 
To do so, please follow the instructions in the [backup guide](../../../0.6.x/installation/#backup-and-restore-keptn)
