...
The rest of this section assumes you have Keptn [installed](../../operate/install/) on your cluster, your CLI is [authenticated](../../operate/install/#authenticate-keptn-cli), and you have a deployed application, which is monitored by your favorite monitoring tool.
The rest of this section now first reviews Keptn projects, stages and services using an example. Afterwards, four steps are listed, which sets up the quality gate and finally triggers an evaluation.
...
For defining the stage(s) but also the tasks a service has to go through, a [Shipyard](../../continuous_delivery/multi_stage/#declare-shipyard-before-creating-a-project) file is needed.
...
## Step 5: Check out the result of the quality gate in Keptn Bridge
TODO
