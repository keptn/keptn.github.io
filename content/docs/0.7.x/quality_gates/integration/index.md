...
<details><summary>[keptn send event start-evaluation](../../reference/cli/commands/keptn_send_event_start-evaluation/) (*recommended*)</summary>
<p>
...
<details><summary>[keptn send event](../../reference/cli/commands/keptn_send_event/)</summary>
<p>
...
<details><summary>Trigger via the dedicated endpoint `/v1/project/{projectName}/stage/{stageName}/service/{serviceName}/evaluation` (recommended)</summary>
<p>
...
* The required payload allows you to set the `start`, `end`, and `timeframe` (choose either the `to` or `timeframe` parameter):
