...
1. Go to the [keptn release](https://github.com/keptn/keptn/archive/0.1.3.tar.gz) page to download the installation file using, e.g., `wget`:
    ```console
    $ cd ~
    $ wget https://github.com/keptn/keptn/archive/0.1.3.tar.gz
    ```
