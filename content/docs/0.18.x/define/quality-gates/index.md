...
* Follow the steps of deploying an SLI-provider and uploading an SLI config
as described at [Add SLI Configuration to a Service, Stage, or Project](../../reference/files/sli/#add-sli-configuration-to-a-service-stage-or-project).
