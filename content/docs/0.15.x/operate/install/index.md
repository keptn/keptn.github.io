...
:bulb: If you would like to install Keptn in a default way, please go to [Quick Start](../../../previous-releases/quickstart/).
...
- Download the version for your operating system from: [GitHub](https://github.com/keptn/keptn/releases/tag/0.15.0)
- Unpack the archive
