...
* To authenticate the CLI against the Keptn cluster, use the [keptn auth](../../{{< param "version" >}}/reference/cli/commands/keptn_auth/) command:
...
follow the instructions [here](../../{{< param "version" >}}/bridge/basic_authentication/#enable-authentication).
