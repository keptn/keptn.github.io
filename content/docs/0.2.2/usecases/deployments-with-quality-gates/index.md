...
| Image                                 | Description                                        |
|---------------------------------------|----------------------------------------------------|
| docker.io/keptnexamples/carts:0.7.2   | Processes each request with a slowdown of 1 second |
| docker.io/keptnexamples/carts:0.7.3   | Processes each request without any slowdown        |
...
1. Besides, you can verify the deployments in your Kubernetes cluster using the following commands: 
    ...
    Pod Template:
      ...
      Containers:
      carts:
        Image:      docker.io/keptnexamples/carts:0.7.3
    ```
    ...
    Pod Template:
      ...
      Containers:
      carts:
        Image:      docker.io/keptnexamples/carts:0.7.1
    ```
