...
The predefined resource values for the Keptn services are available in the [helm-charts](https://github.com/keptn/keptn/blob/0.11.4/installer/manifests/keptn/charts/control-plane/templates/core.yaml).
