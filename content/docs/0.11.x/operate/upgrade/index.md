...
## Upgrade from Keptn 0.9.x to 0.11.0
...
1. To download and install the Keptn CLI for version 0.11.0, you can choose between:
...
1. To upgrade your Keptn installation from 0.9.x to 0.11.0, the Keptn CLI offers the command:
```console
keptn upgrade
```
