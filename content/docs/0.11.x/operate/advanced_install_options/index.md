...
```
helm install keptn https://github.com/keptn/keptn/releases/download/0.11.3/keptn-0.11.3.tgz -n keptn --create-namespace --wait --set=continuous-delivery.enabled=true,control-plane.apiGatewayNginx.type=LoadBalancer
```

* *Install Keptn execution-plane:*

```
helm install jmeter-service https://github.com/keptn/keptn/releases/download/0.11.3/jmeter-service-0.11.3.tgz -n keptn --create-namespace --wait

helm install helm-service https://github.com/keptn/keptn/releases/download/0.11.3/helm-service-0.11.3.tgz -n keptn --create-namespace --wait
```
...
The full list of available flags can be found in the [helm-charts](https://github.com/keptn/keptn/tree/0.11.3/installer/manifests/keptn).


### Example: Use a LoadBalancer for api-gateway-nginx

```console
helm upgrade keptn keptn --install -n keptn --create-namespace --wait --version=0.11.3 --repo=https://storage.googleapis.com/keptn-installer --set=control-plane.apiGatewayNginx.type=LoadBalancer
```
...
```console
helm upgrade keptn keptn --install -n keptn --create-namespace --wait --version=0.11.3 --repo=https://storage.googleapis.com/keptn-installer --set=continuous-delivery.enabled=true
```
...
```console
helm upgrade keptn keptn --install -n keptn --create-namespace --wait --version=0.11.3 --repo=https://storage.googleapis.com/keptn-installer --set=continuous-delivery.enabled=true,control-plane.apiGatewayNginx.type=LoadBalancer
```
...
Download the Helm charts from the [Keptn 0.11.3 release](https://github.com/keptn/keptn/releases/tag/0.11.3):

* Keptn Control Plane: https://github.com/keptn/keptn/releases/download/0.11.3/keptn-0.11.3.tgz
* helm-service (if needed): https://github.com/keptn/keptn/releases/download/0.11.3/helm-service-0.11.3.tgz
* jmeter-service (if needed): https://github.com/keptn/keptn/releases/download/0.11.3/jmeter-service-0.11.3.tgz
...
mkdir offline-keptn
cd offline-keptn
curl -L https://github.com/keptn/keptn/releases/download/0.11.3/keptn-0.11.3.tgz -o keptn-0.11.3.tgz
curl -L https://github.com/keptn/keptn/releases/download/0.11.3/helm-service-0.11.3.tgz -o helm-service-0.11.3.tgz
curl -L https://github.com/keptn/keptn/releases/download/0.11.3/jmeter-service-0.11.3.tgz -o jmeter-service-0.11.3.tgz
cd ..
```
...
```console
cd offline-keptn
curl -L https://raw.githubusercontent.com/keptn/keptn/0.11.3/installer/airgapped/pull_and_retag_images.sh -o pull_and_retag_images.sh
chmod +x pull_and_retag_images.sh
KEPTN_TAG=0.11.3 ./pull_and_retag_images.sh "your-registry.localhost:5000/"
cd ..
```
...
```console
cd offline-keptn
curl -L https://raw.githubusercontent.com/keptn/keptn/0.11.3/installer/airgapped/install_keptn.sh -o install_keptn.sh
chmod +x install_keptn.sh
./install_keptn.sh "your-registry.localhost:5000/" keptn-0.11.3.tgz helm-service-0.11.3.tgz jmeter-service-0.11.3.tgz
cd ..
```
...
```console
helm upgrade keptn keptn --install -n keptn --create-namespace --wait --version=0.11.3 --repo=https://storage.googleapis.com/keptn-installer --set=control-plane.apiGatewayNginx.type=LoadBalancer,continuous-delivery.enabled=true,control-plane.prefixPath=/mykeptn
```
