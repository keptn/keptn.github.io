...
Please find the Helm Charts here:
  ...
  - `helm-service`: GitHub Release for [0.11.4](https://github.com/keptn/keptn/releases/tag/0.11.4) at **Assets** > `helm-service-0.11.4.tgz`

  - `jmeter-service`: GitHub Release for [0.11.4](https://github.com/keptn/keptn/releases/tag/0.11.4) at **Assets** > `jmeter-service-0.11.4.tgz`
...
* Download the `values.yaml` from the release branch, e.g., for the jmeter-service:
    ...
    ```
    wget https://raw.githubusercontent.com/keptn/keptn/release-0.11.4/jmeter-service/chart/values.yaml
    ```
...
* Deploy the execution plane service (e.g., jmeter-service) from release assets with your `values.yaml` and by using `helm`:
    ...
    ```console
    helm install jmeter-service https://github.com/keptn/keptn/releases/download/0.11.4/jmeter-service-0.11.4.tgz -n keptn-exec --create-namespace --values=values.yaml
    ```
...
See the configuration parameters of the supported execution plane services:
  ...
  - `helm-service`: [Helm Chart values](https://github.com/keptn/keptn/blob/release-0.11.4/helm-service/chart/README.md#configuration)

  - `jmeter-service`: [Helm Chart values](https://github.com/keptn/keptn/blob/release-0.11.4/jmeter-service/chart/README.md#configuration)
