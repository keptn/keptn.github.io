...
*Note:* Custom data in the event payload is available only for `triggered` task suffix.
...
<details><summary>*Preview* of customization support released with 0.13.0</summary>
<p>
