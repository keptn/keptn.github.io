...
## 2a. Create GKE cluster through Cloud Console
  ...
  - Image type `ubuntu` or `cos` (if you plan to use Dynatrace monitoring, select `ubuntu` for a more [convenient setup](https://keptn.sh/docs/0.6.0/reference/monitoring/dynatrace/#notes))
