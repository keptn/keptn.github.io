...
Use the [Keptn CLI](../../{{< param "version" >}}/reference/cli/) to send commands
that interact with the [Keptn API](../../{{< param "version" >}}/reference/api/).
...
See [Keptn Bridge](../../{{< param "version" >}}/bridge/),
...
The [Keptn API](../../{{< param "version" >}}/reference/api/) provides a REST API
...
forward [CloudEvents](../../{{< param "version" >}}/reference/miscellaneous/events/)
...
in the [values.yaml](../../{{< param "version" >}}/reference/files/values/) file.
...
It uses the Git-based [upstream repository](../../{{< param "version" >}}/manage/git_upstream/)
...
that are defined in the project's [shipyard](../../{{< param "version" >}}/reference/files/shipyard/)
...
* [distributor](../../{{< param "version" >}}/reference/miscellaneous/distributor/) sidecar
...
- **approval-service:** implements the automatic quality gate in each stage
  ...
  (using either the [Keptn Bridge](../../{{< param "version" >}}/bridge/#approvals) or the API).  
...
Use the information in [Custom Integrations](../../{{< param "version" >}}/integrations/)
...
on the [distributor](../../{{< param "version" >}}/reference/miscellaneous/distributor/) reference page
...
that are documented on the [shipyard](../../{{< param "version" >}}/reference/files/shipyard/#fields) reference page.
