...
the [Keptn Bridge](../../{{< param "version" >}}/bridge/), the Keptn CLI or the Keptn API. 
1. Once triggered, Keptn fetches the [SLIs](../../{{< param "version" >}}/reference/files/sli/). 
...
See the [SLI reference page](../../{{< param "version" >}}/reference/files/sli/) for details.
...
quality gate results on the [Keptn Bridge](../../{{< param "version" >}}/bridge/) like this:
