...
* To get the values for `KEPTN_API_URL` and `KEPTN_API_TOKEN`, please see [Authenticate Keptn CLI](https://keptn.sh/docs/0.7.x/operate/install/#5-authenticate-keptn-cli).
