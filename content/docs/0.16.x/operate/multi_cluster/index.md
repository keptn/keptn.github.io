...
* Download the `values.yaml` from the release branch, e.g., for the jmeter-service:
    ...
    ```
    wget https://raw.githubusercontent.com/keptn/keptn/release-0.16.0/jmeter-service/chart/values.yaml
    ```
...
See the configuration parameters of the supported execution plane services:
  ...
  - `helm-service`: [Helm Chart values](https://github.com/keptn/keptn/blob/release-0.16.0/helm-service/chart/README.md#configuration)

  - `jmeter-service`: [Helm Chart values](https://github.com/keptn/keptn/blob/release-0.16.0/jmeter-service/chart/README.md#configuration)
