...
* Helm-releases created for deployments are not deleted. To clean-up deployed Helm releases, please see [Clean-up after deleting a project](https://v1.keptn.sh/docs/0.9.x/continuous_delivery/deployment_helm/#clean-up-after-deleting-a-project)
